...
def terms_and_conditions(request):
    ...
    if not terms:
        ...
        terms = TermsAndConditions(
            ...
            content="""
<h1>شرایط و قوانین استفاده از MobixAI</h1>

<p><strong>آخرین به‌روزرسانی:</strong> ۱۴ مهر ۱۴۰۴</p>

<h2>۱. پذیرش شرایط</h2>
<p>با استفاده از سرویس MobixAI، شما به‌طور کامل با این شرایط و قوانین موافقت می‌کنید. در صورت مخالفت با هر یک از این شرایط، لطفاً از استفاده از سرویس خودداری فرمایید.</p>

<h2>۲. تعریف سرویس</h2>
<p>MobixAI یک پلتفرم هوش مصنوعی است که به کاربران امکان چت با مدل‌های زبان طبیعی، تولید محتوا، ترجمه هوشمند و اتوماسیون کارهای روزمره را می‌دهد.</p>

<h2>۳. حقوق کاربران</h2>
<ul>
  <li>دسترسی به مدل‌های هوش مصنوعی پیشرفته</li>
  <li>استفاده از قابلیت‌های چت و تولید محتوا</li>
  <li>دریافت پشتیبانی فنی</li>
  <li>حفظ حریم خصوصی اطلاعات شخصی</li>
</ul>

<h2>۴. مسئولیت‌های کاربران</h2>
<ul>
  <li>رعایت قوانین جمهوری اسلامی ایران</li>
  <li>عدم استفاده از سرویس در امور غیرقانونی</li>
  <li>عدم تلاش برای نفوذ به سیستم یا دسترسی غیرمجاز</li>
  <li>احراز هویت صحیح و ارائه اطلاعات واقعی</li>
</ul>

<h2>۵. حریم خصوصی</h2>
<p>اطلاعات کاربران به‌صورت کامل محرمانه می‌ماند و برای اهداف غیرقانونی استفاده نخواهد شد. برای اطلاعات بیشتر، <a href="/privacy-policy/">سیاست حریم خصوصی</a> ما را مطالعه فرمایید.</p>

<h2>۶. محدودیت‌های استفاده</h2>
<ul>
  <li>محدودیت در تعداد پیام‌ها و استفاده روزانه بر اساس نوع اشتراک</li>
  <li>محدودیت در حجم و نوع فایل‌های قابل آپلود</li>
  <li>امکان مسدودسازی دسترسی در صورت سوءاستفاده</li>
</ul>

<h2>۷. تغییرات در شرایط</h2>
<p>MobixAI مجاز است این شرایط را در هر زمان و بدون اطلاع قبلی تغییر دهد. کاربران مسئول بررسی منظم این صفحه هستند.</p>

<h2>۸. تماس با ما</h2>
<p>برای سوالات بیشتر، با ما از طریق <a href="mailto:support@mobixai.ir">support@mobixai.ir</a> تماس بگیرید.</p>
            """.strip()
        )
        terms.save()
