...
class MultiFileUploadManager {
  ...
  attachEventListeners() {
    ...
    if (this.elements.uploadBtn && document.contains(this.elements.uploadBtn)) {
      ...
      this.elements.uploadBtn.removeEventListener(
        "click",
    ...
    if (
      ...
      document.contains(this.elements.clearAllBtn)
    ) {
      // Remove any existing listeners to prevent duplicates
      this.elements.clearAllBtn.removeEventListener(
        "click",
        this.clearAllFiles,
      );
    ...
    if (
      ...
      document.contains(this.elements.messageInput)
    ) {
      // Remove any existing listeners to prevent duplicates
  ...
  triggerFileSelect() {
    ...
    if (this.elements.fileInput && document.contains(this.elements.fileInput)) {
      ...
      console.warn(
        "File input element is no longer valid, refreshing elements",
      );
  ...
  updateFilePreview() {
    ...
    if (
      ...
      !document.contains(this.elements.preview) ||
      !document.contains(this.elements.filesList) ||
      !document.contains(this.elements.filesCount)
    ) {
  ...
  updateSendButtonState() {
    ...
    if (
      ...
      !this.elements.messageInput ||
      !document.contains(this.elements.sendBtn) ||
      !document.contains(this.elements.messageInput)
    ) {
